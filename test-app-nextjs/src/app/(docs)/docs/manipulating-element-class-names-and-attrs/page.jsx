    ...
    <>
      <div className="docs-md">
        ...
        <ul class="docs-list-disc">
          ...
          <li>
            the <code>inputField</code> namespace is only applied to the input element in the built in <Link href="/docs/input">Input field</Link>,
          </li>
          <li>
            the <code>powerDatePickerTimeSelectorInput</code> namespace is only applied to the input elements in the built in <Link href="/docs/power-datepicker">Power Datepicker field</Link>.
          </li>
        </ul>
        <p>
        ...
        <p>
          See <Link href="/docs/debug-mode">the debug mode docs</Link> for more.
        </p>
        <h2
          id="default-config"
          class="docs-md__h2"
