  ...
  return (
    <>
      <div className="docs-md">
        <h1 id="radio-button-group" class="docs-md__h1">
          Radio button group
        </h1>
        <p>
          Renders a radio button group. The value of the field as a whole is the{' '}
          <code>value</code> property of the currently selected option.
        </p>
        <h2 id="radio-button-group-props" class="docs-md__h2">
          <a href="#radio-button-group-props" class="heading-anchor">
        ...
        />
        <h2 id="radio-button-group-options-prop" class="docs-md__h2">
          <a href="#radio-button-group-options-prop" class="heading-anchor">
            Radio button group <code>options</code> prop
          </a>
        </h2>
        <p>
          Each option in the <code>options</code> property of field with type{' '}
          <code>radioButtonGroup</code> can have the following properties.
        </p>

        <DocsSnippet name="radio-button-group-option.js" />
        <p>
          You can also pass a primitive value, such as a string or number as an
          option. In this case the option will be expanded into an object in
          which the values of the <code>label</code> and <code>value</code>{' '}
        ...
        <h2 id="option-label-content-in-markdown" class="docs-md__h2">
          <a href="#option-label-content-in-markdown" class="heading-anchor">
            Option label content in markdown
          </a>
        </h2>
        <p>
          Pass a string of markdown content as <code>optionLabelmarkdown</code>{' '}
          and it will be rendered inside the label element for the option.
        </p>
        ...
        <ul class="docs-list-disc">
          <li>
            passing <code>optionLabelComponent</code> to the field. The
            component passed will then be rendered in place of the standard
            label element for each option.
          </li>
          <li>
            by passing <code>labelComponent</code> to a specific option. The
            component passed will then be rendered in place of the standard
            label element for that specific option, and will override{' '}
            <code>optionLabelComponent</code>.
          </li>
        </ul>
        <p>
          In both cases the following applies, the object passed must take the
          following form.
        </p>
        ...
        <ul class="docs-list-disc">
          <li>
            ...
            <code>label</code> and <code>value</code> props for that option.
          </li>
          <li>
            ...
            <ul class="docs-list-disc">
              <li>
                ...
                browser knows which radio button the label is for.
              </li>
              <li>
                Set <code>id=</code> so that the <code>aria-labelledby</code>{' '}
                attribute on the radio button works correctly.
              </li>
            </ul>
          </li>
        </ul>
