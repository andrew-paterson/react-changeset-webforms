  ...
  return (
    <>
      <div className="docs-md">
        <h1 id="checkbox-group" class="docs-md__h1">
          Checkbox group
        </h1>
        <p>
          Renders a checkbox group. The value of the field as a whole is an
          array which will include the value of <code>key</code> for each option
        ...
        <p>
          ...
          <code>checkboxGroup</code> can have the following properties.
        </p>

        <DocsSnippet
          name="checkbox-group-option.js"
        ...
        <p>
          ...
          which the values of the <code>key</code> and <code>value</code>{' '}
        ...
        <ul class="docs-list-disc">
          <li>
            ...
            <code>label</code>, <code>key</code>, and{' '}
            <code>onlyCheckedOption</code> props for that option.
          </li>
          <li>
