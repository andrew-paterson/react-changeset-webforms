  ...
  return (
    <>
      <div className="docs-md">
        ...
        <p>
          Renders a checkbox group. The value of the field as a whole is an array which will include the value of <code>key</code> for each option that is currently selected.
        </p>

        <DocsSnippet name="checkbox-group-options.js" />
        ...
        <p>
          Each option in the <code>options</code> property of field with type <code>checkboxGroup</code> can have the following properties.
        </p>

        <DocsSnippet
          name="checkbox-group-options.js"
          title="Checkbox group options"
        />
        <p>
          You can also pass a primitive value, such as a string or number as an option. In this case the option will be expanded into an object in which the values of the <code>key</code> and <code>value</code> properties will be the same.
        </p>
        <p>The above props are in addition to the generic field props shown with their default values below.</p>
        ...
        <ul class="docs-list-disc">
          <li>
            The component template will have access to the <code></code> boolean as well as the <code></code> hash which includes the <code>label</code>, <code>key</code>, and <code>onlyCheckedOption</code> props for that option.
          </li>
          <li>
            Accessibility features
            <ul class="docs-list-disc">
              <li>
                Set <code>for=</code> on the label element, to ensure that the browser knows which checkbox the label is for.
              </li>
              <li>
                Set <code>id=</code> so that the <code>aria-labelledby</code> attribute on the checkbox works correctly.
              </li>
            </ul>
          </li>
        </ul>
