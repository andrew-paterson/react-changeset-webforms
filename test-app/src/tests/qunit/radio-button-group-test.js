...
module('Acceptance | Radio button group', function (hooks) {
  ...
  test('With component label', async function (assert) {
    await visit('/docs/radio-button-group');
    assert.dom(`${testEls.radioButtonGroupExample2FormRadioButtons2Field}`).hasText('Custom label components Option 1 This is a custom label component applied to all of the radio options Option 2 This is a custom label component applied to all of the radio options Option 3 This is a custom component for the label of one specific radio option More info', 'Both field.optionLabelComponent and option.optionLabelComponent are loading correctly, and the option and props obejcts are passed in correctly to field.optionLabelComponent.');
    await click(`${testEls.radioButtonGroupExample2} ${testEls.moreInfoToggler}`);
    assert.dom(`${testEls.radioButtonGroupExample2FormRadioButtons2Field}`).hasText('Custom label components Option 1 This is a custom label component applied to all of the radio options Option 2 This is a custom label component applied to all of the radio options Option 3 This is a custom component for the label of one specific radio option More info This text was passed to the label component dynamically for this option, via the optionLabelComponent.props object.', 'The option and props obejcts are correctly passed in to option.optionLabelComponent.');
  });
